...
class PlayState extends MusicBeatState
{
			...
			case 'pgtstage':
				{
					defaultCamZoom = 0.75;
					curStage = 'pgtstage';
					var bg:FlxSprite = new FlxSprite(-600, -200).loadGraphic(Paths.image('pgtback'));
					bg.antialiasing = true;
					bg.scrollFactor.set(0.9, 0.9);
					bg.active = false;
					add(bg);

					var stageCurtains:FlxSprite = new FlxSprite(-500, -300).loadGraphic(Paths.image('pgtcurtains'));
					stageCurtains.setGraphicSize(Std.int(stageCurtains.width * 0.9));
					stageCurtains.updateHitbox();
					stageCurtains.antialiasing = true;
					...
					var stageFront:FlxSprite = new FlxSprite(-650, 600).loadGraphic(Paths.image('pgtfront'));
					stageFront.setGraphicSize(Std.int(stageFront.width * 1.1));
					stageFront.updateHitbox();
					stageFront.antialiasing = true;
					stageFront.scrollFactor.set(0.9, 0.9);
	...
	override public function update(elapsed:Float)
	{
		...
		// changing this to a skip song button temporarily PLEASE undo this later ohg my god
